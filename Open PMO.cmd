...
exit /b 1
:launch
"%PMO_PS%" -NoLogo -NoProfile -File "%~dp0scripts\open-hub.ps1"
if "%ERRORLEVEL%"=="2" goto starting
if not errorlevel 1 exit /b 0
echo.
echo The PMO workspace could not be opened. Read the message above; no project data was reset.
pause
exit /b 1
:starting
echo.
echo The server is still starting. Double-click Open PMO.cmd again to continue waiting.
pause
exit /b 0
